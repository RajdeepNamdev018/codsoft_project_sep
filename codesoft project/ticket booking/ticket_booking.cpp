...
int main(){
    ...
    switch(choice){
        ...
        case 2: system("cls");
                cout<<" For further information about movies you can download our Application(from the  Google Play Store or from the iOS App Store) or contact us at 09685773483";      
                cout<<"\n Do you want to choose another option(y/n)";
                cin>>ans;
                system("cls");
                break;
